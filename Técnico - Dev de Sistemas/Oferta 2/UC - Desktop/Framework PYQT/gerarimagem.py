from PySide6.QtWidgets import QApplication, QLabel, QMainWindow, QWidget, QVBoxLayout #Ferramentas pra criar os componentes gráficos, como as janelas
...
class NameWindow(QMainWindow):
    def __init__(self):
        ...
        label.setStyleSheet("font-size: 23px; color: red; font-weight: bold; text-align: center;")
...
if __name__ == "__main__": #Só vai executar o comando e abrir a janela se for o arquivo principal
    ...
    window = NameWindow() #Passando os métodos que personalizamos
